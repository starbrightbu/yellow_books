# -*- coding: utf-8 -*-
"""도서관공모전_도서관병원링크모델_최종_최종.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1jSwstQON2hVsgHYpkNUqzq64dsF6BvJG
"""

import pandas as pd
# 파일 불러오기
df = pd.read_csv('df5.csv', encoding='cp949')
...
# lib_jung, lib_pyung, lib_weol, lib_sang 열이 모두 NaN이면 match_yes에 0, 하나라도 NaN이 아니면 1
...
len(df_final_matched)



# df_final_matched 다운
df_final_matched.to_csv('df_final_matched.csv', index=False)